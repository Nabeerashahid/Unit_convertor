...
#Build a google convertor using python and streamlit
...
st.markdown(
    ...
    .stButton>button {
        background: linear-gradient(45deg,rgb(95, 11, 148), #351c75);
        color:black;
        font-size: 18px;
        padding: 10px 20px;
        border-radius: 10px;
...
st.write("Easily convert different units of length , weight and temperature.")
...
if conversion_type == "Length":
    ...
    with col2:
        to_unit = st.selectbox("To", ["Celsius", "Fahrenhiet", "Kelvin"])
...
st.markdown("<div class='footer'> Created with love by Nabeera </div>", unsafe_allow_html=True)